...
```bash
curl -fsSL https://raw.githubusercontent.com/rrmlima/customer-agent-installer/main/install.sh | bash
```
...
```bash
curl -fsSLO https://raw.githubusercontent.com/rrmlima/customer-agent-installer/main/install.sh
less install.sh
bash install.sh
```
